...
// Returns the private 'App\Repository\SituationMatrimonialeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SituationMatrimonialeRepository.php';

return $this->privates['App\Repository\SituationMatrimonialeRepository'] = new \App\Repository\SituationMatrimonialeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
