...
// Returns the private 'App\Repository\FoyerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FoyerRepository.php';

return $this->privates['App\Repository\FoyerRepository'] = new \App\Repository\FoyerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
