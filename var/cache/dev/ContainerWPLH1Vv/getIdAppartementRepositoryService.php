...
// Returns the private 'App\Repository\IdAppartementRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IdAppartementRepository.php';

return $this->privates['App\Repository\IdAppartementRepository'] = new \App\Repository\IdAppartementRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
