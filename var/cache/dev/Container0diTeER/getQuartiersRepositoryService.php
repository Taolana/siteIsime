...
// Returns the private 'App\Repository\QuartiersRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/QuartiersRepository.php';

return $this->privates['App\Repository\QuartiersRepository'] = new \App\Repository\QuartiersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
