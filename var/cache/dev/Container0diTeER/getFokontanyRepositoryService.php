...
// Returns the private 'App\Repository\FokontanyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FokontanyRepository.php';

return $this->privates['App\Repository\FokontanyRepository'] = new \App\Repository\FokontanyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
