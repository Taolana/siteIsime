...
// Returns the private 'App\Repository\IndividuRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IndividuRepository.php';

return $this->privates['App\Repository\IndividuRepository'] = new \App\Repository\IndividuRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
