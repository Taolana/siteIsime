...
// Returns the private 'App\Repository\DepenseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DepenseRepository.php';

return $this->privates['App\Repository\DepenseRepository'] = new \App\Repository\DepenseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
