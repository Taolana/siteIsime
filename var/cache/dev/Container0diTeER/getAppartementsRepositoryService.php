...
// Returns the private 'App\Repository\AppartementsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AppartementsRepository.php';

return $this->privates['App\Repository\AppartementsRepository'] = new \App\Repository\AppartementsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
