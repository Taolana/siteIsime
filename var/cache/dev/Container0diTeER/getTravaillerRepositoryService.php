...
// Returns the private 'App\Repository\TravaillerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TravaillerRepository.php';

return $this->privates['App\Repository\TravaillerRepository'] = new \App\Repository\TravaillerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
